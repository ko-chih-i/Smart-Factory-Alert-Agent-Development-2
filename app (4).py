...
def generate_sensor_data(num_rows=200, anomaly_ratio=0.12, inject_missing=False, missing_rate=0.04, seed=42):
    ...
    for i in range(num_rows):
        ...
        current_pressure = 0.70 * current_pressure + 0.30 * target_press + (random.random() - 0.5) * 0.014
        current_vibration = 0.70 * current_vibration + 0.30 * target_vib + (random.random() - 0.5) * 0.006
